...
namespace AsyncSocketServer
{
    ...
    public class AsyncSocketInvokeElement
    {
        ...
        public virtual bool SendCompleted()
        {
            ...
            {
                m_sendAsync = true;
                return m_asyncSocketServer.SendAsyncEvent(m_asyncSocketUserToken.ClientSocket, m_asyncSocketUserToken.SendEventArgs,
        ...
        public bool DoSendResult()
        {
            ...
            if (!m_sendAsync)
            {
                ...
                {
                    m_sendAsync = true;
                    result = m_asyncSocketServer.SendAsyncEvent(m_asyncSocketUserToken.ClientSocket, m_asyncSocketUserToken.SendEventArgs, 
