    ...
    public class AsyncSocketServer
    {
        ...
        private void ProcessReceive(SocketAsyncEventArgs receiveEventArgs)
        {
            ...
            if (userToken.ReceiveEventArgs.BytesTransferred > 0 && userToken.ReceiveEventArgs.SocketError == SocketError.Success)
            {
                ...
                if ((userToken.AsyncSocketInvokeElement == null) & (userToken.ClientSocket != null)) //存在Socket对象，并且没有绑定协议对象，则进行协议对象绑定
                {
                ...
                {
                    Program.Logger.WarnFormat("Illegal client connection. Local Address: {0}, Remote Address: {1}", userToken.ClientSocket.LocalEndPoint, 
