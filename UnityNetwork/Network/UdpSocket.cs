...
public class UdpSocket {
    ...
    private const UInt32 CLOSED_TIMEOUT = 5000;
    ...
    private bool mInCloseStage;
    private UInt32 mCloseTime;
    private string mCloseReason;

    private SwitchQueue<byte[]> mRecvQueue = new SwitchQueue<byte[]>(128);

    public bool InCloseStage { private set { } get { return mInCloseStage; } }
    ...
    bool close_timeout(UInt32 current)
    {
        return current - mCloseTime > CLOSED_TIMEOUT;
    }
