...
namespace Photon.SocketServer.Rpc.Protocols
{
    ...
    /// </summary>
    internal class RtsMessageHeaderConverterAmf3V2 : IRtsMessageHeaderConverter
    {
        /// <summary>
        /// Singleton instance.
        /// </summary>
        public static readonly RtsMessageHeaderConverterAmf3V2 Instance = new RtsMessageHeaderConverterAmf3V2();
        ...
        /// </summary>
        private RtsMessageHeaderConverterAmf3V2()
        {
        }
