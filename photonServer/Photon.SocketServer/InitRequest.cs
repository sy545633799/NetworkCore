...
namespace Photon.SocketServer
{
    ...
    public sealed class InitRequest
    {
        ...
        internal InitRequest(string applicationId, Version clientVersion, IRpcProtocol protocol)
        {
        ...
        /// </summary>
        /// <remarks> Peers connected to different ports may have similar connection ids.</remarks>
